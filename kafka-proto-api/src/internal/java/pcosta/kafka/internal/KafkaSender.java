...
class KafkaSender<KEY, OUT> {
     ...
     *
     * @param srcTopic        this sender's source Topic
     ...
     */
    KafkaSender(String srcTopic, String dstTopic, Serializer<KEY> keySerializer, Serializer<OUT> valueSerializer) {
     ...
     */
    KafkaSender(String srcTopic, String dstTopic, Serializer<KEY> keySerializer, Serializer<OUT> valueSerializer, Map<String, Object> properties) {
        this.srcTopic = srcTopic;
        this.dstTopic = dstTopic;
        this.keySerializer = keySerializer;
        this.valueSerializer = valueSerializer;
    ...
    private Map<String, Object> senderProps() {
        ...
        properties.put(ProducerConfig.CLIENT_ID_CONFIG, srcTopic.toLowerCase() + "->" + dstTopic.toLowerCase());
